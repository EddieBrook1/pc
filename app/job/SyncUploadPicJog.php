...
class SyncUploadPicJog{
    ...
    // 更新主任务的payload
    private function buildNewlyPayload ($old_payload, $pic_id, $pic_url) {
    ...
    public function fire(Job $job, $data){
        ...
        try {
            ...
            // 获取新的payload数据
            $newly_payload = $this->buildNewlyPayload($syncMainJob->payload, $pic_id, $pic_url);
            ...
            if ($this->isAllPicComplete($newly_payload)) {
                ...
                $syncMainJob->result_json = TbUtil::buildSyncMainJobResult(
                    $syncMainJob->
                );
            }
