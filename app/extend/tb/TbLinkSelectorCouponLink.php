...
/**
 * 链接选择器-优惠券
 * 使用的接口: https://wangpu.taobao.com/shopdecorate/ajax/tool/getCouponLinkList.do
 * 当前(2021-12-24)的返回格式:
    [
        'isSuccess' => true,
        'module' => [xxxx]
 ...
 */
class TbLinkSelectorCouponLink {
    ...
    public function handle ($cookie, $currentPage, $pageSize) {
        ...
        $url = 'https://wangpu.taobao.com/shopdecorate/ajax/tool/getCouponLinkList.do';
