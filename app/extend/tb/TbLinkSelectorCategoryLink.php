...
/**
 * 链接选择器-宝贝分类
 * 使用的接口: https://wangpu.taobao.com/shopdecorate/ajax/tool/getItemCategoryLinkList.do
 * 当前(2021-12-24)的返回格式:
    [
        'isSuccess' => true,
        'module' => [xxxx]
 ...
 */
class TbLinkSelectorCategoryLink {
    ...
    // 入口
    public function handle ($cookie, $currentPage, $pageSize) {

        $url = 'https://wangpu.taobao.com/shopdecorate/ajax/tool/getItemCategoryLinkList.do';
